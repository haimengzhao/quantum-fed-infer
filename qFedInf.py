...
if __name__ == '__main__':
    ...
    for world in tqdm(range(n_world)):
        ...
        world_train_loss.append(all_train_loss)
        world_train_acc.append(all_train_acc)
    ...
    os.makedirs(f'./{dataset}/qFedInf/', exist_ok=True) 
    jnp.save(f'./{dataset}/qFedInf/train_loss.npy', world_train_loss)
    jnp.save(f'./{dataset}/qFedInf/train_acc.npy', world_train_acc)
    jnp.save(f'./{dataset}/qFedInf/test_loss.npy', world_test_loss)
    jnp.save(f'./{dataset}/qFedInf/test_acc.npy', world_test_acc)
